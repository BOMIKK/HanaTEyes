...
public final class ActivityIntroBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView ex1;

  private ActivityIntroBinding(@NonNull LinearLayout rootView, @NonNull ImageView ex1) {
  ...
  public static ActivityIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.ex1;
      ImageView ex1 = rootView.findViewById(id);
      if (ex1 == null) {
        break missingId;
      }

      return new ActivityIntroBinding((LinearLayout) rootView, ex1);
    }
